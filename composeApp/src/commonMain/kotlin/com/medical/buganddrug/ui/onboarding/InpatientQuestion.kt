...

{
    ...
    val askMeQuestions = listOf(
        Question(1, "Quick ID Consult"),
        Question(2, "Clinical Syndrome"),
        Question(3, "Etiological Agent"),
        Question(4, "Antimicrobials"),
        Question(5, "Antimicrobial Spectrum"),
        Question(6, "Creatinine Clearance Calculator"),
        Question(7, "TB / HIV / STI"),
        Question(8, "Vaccination")
    )
    Scaffold(
        topBar = {
            topBar(
